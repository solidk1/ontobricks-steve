...
For the secret-scope setup see `documentation/neo4j-secret-configuration.md`, and
for the original end-to-end demo artefacts `documentation/pr47-neo4j-demo/`. For the
